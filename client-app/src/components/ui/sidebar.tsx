  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-side=left]_&]:rtl:cursor-e-resize [[data-side=right]_&]:rtl:cursor-w-resize",
        "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
        "[[data-side=left][data-state=collapsed]_&]:rtl:cursor-w-resize [[data-side=right][data-state=collapsed]_&]:rtl:cursor-e-resize",
